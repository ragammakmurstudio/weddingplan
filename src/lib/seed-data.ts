...
export function defaultWeddingState(): WeddingState {
  return {
    ...
    maharItems: [
      { id: "seed-mahar-1", title: "Logam Mulia Antam 10 Gram", cost: 13500000, ready: true },
      { id: "seed-mahar-2", title: "Set Perhiasan Emas 5 Gram", cost: 6500000, ready: true },
      { id: "seed-mahar-3", title: "Seperangkat Alat Sholat Premium", cost: 1500000, ready: true },
    ],
    seserahanCppToCpw: [
      { id: "seed-se-cpp1", title: "Set Skincare & Cosmetic", cost: 2500000, ready: true },
      { id: "seed-se-cpp2", title: "Tas & Sepatu Pesta CPW", cost: 3500000, ready: false },
      { id: "seed-se-cpp3", title: "Kain Kebaya & Bahan Pakaian", cost: 2000000, ready: true },
    ],
    seserahanCpwToCpp: [
      { id: "seed-se-cpw1", title: "Set Jas Formal & Sepatu Pria", cost: 3000000, ready: false },
      { id: "seed-se-cpw2", title: "Parfum & Grooming Kit", cost: 1500000, ready: true },
    ],
    vendors: [
      {
        id: "seed-vendor-1",
    ...
    checklist: [
      { id: "seed-cl-1", timeframe: "H-12 s/d H-9 Bulan", task: "Menentukan Budget Pernikahan & Konsep Utama", done: true },
      { id: "seed-cl-2", timeframe: "H-12 s/d H-9 Bulan", task: "Booking Tanggal & Venue / Gedung Pernikahan", done: true },
      { id: "seed-cl-3", timeframe: "H-8 s/d H-6 Bulan", task: "Booking Catering", done: true },
      { id: "seed-cl-4", timeframe: "H-8 s/d H-6 Bulan", task: "Booking MUA (Makeup Artist)", done: true },
      { id: "seed-cl-5", timeframe: "H-8 s/d H-6 Bulan", task: "Booking Busana Pengantin", done: true },
      { id: "seed-cl-6", timeframe: "H-8 s/d H-6 Bulan", task: "Booking Dekorasi", done: true },
      { id: "seed-cl-7", timeframe: "H-5 s/d H-3 Bulan", task: "Mengurus Pendaftaran Berkas Administrasi KUA", done: false },
      { id: "seed-cl-8", timeframe: "H-5 s/d H-3 Bulan", task: "Beli / Pesan Mahar & Hantaran Seserahan", done: true },
    ...
    committeeList: [
      { id: "seed-cm-1", role: "Saksi Nikah CPP", name: "Bpk. Drs. Soeparno", uniformGiven: true },
      { id: "seed-cm-2", role: "Penerima Tamu 1", name: "Siti & Maya", uniformGiven: true },
      { id: "seed-cm-3", role: "Penerima Tamu 2", name: "Dian & Rina", uniformGiven: false },
      { id: "seed-cm-4", role: "PIC Konsumsi / Catering", name: "Paman Budi", uniformGiven: true },
    ],
  };
}
